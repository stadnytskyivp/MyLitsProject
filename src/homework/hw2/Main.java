...
/*Дз
 Зробити класс array який матиме змінну int [] arr і через конструктор щоб можна було її
 ініціалізувати + має бути дефолтний конструктор.  +
 В класі мають бути методи які :
 повернути середнє арифметичне масиву, +
 найбільше значення в масиві,  +
 найменше значення в масив, +
 повертати новий масив з парних значень даного, +
